...
var PointDlg = (function (_super) {
    __extends(PointDlg, _super);
    function PointDlg(awardData) {
        if (awardData === void 0) { awardData = []; }
        var _this = _super.call(this) || this;
        _this.addEventListener(egret.Event.ADDED_TO_STAGE, _this.onAddToStage, _this);
        return _this;
    }
    PointDlg.prototype.onAddToStage = function (event) {
...
__reflect(PointDlg.prototype, "PointDlg");
