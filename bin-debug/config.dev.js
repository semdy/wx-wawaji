var URLObj = (function () {
    var URLObj = {
        ...
        weixinAuthUser: "https://open.weixin.qq.com/connect/oauth2/authorize?appid={appid}&redirect_uri=http%3A%2F%2F{hostname}%2FOrderUI-wheat%2Factivity%2Factivitys%2Fwawaji%2Fproxy.html?uname={uname}%26spreadId={spreadId}&response_type=code&scope=snsapi_base&state=123456#wechat_redirect",
        Config: {
            urls: {
